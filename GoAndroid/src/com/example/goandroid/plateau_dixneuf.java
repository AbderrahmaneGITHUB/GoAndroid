...
public class plateau_dixneuf extends MainActivity{
	public View maVue;
    	...
    	new View.OnTouchListener() {
            public boolean onTouch(View myView, MotionEvent event) {            	            
                ...
                if (action==MotionEvent.ACTION_UP)
                {
                	...
                	{
                		Toast.makeText(plateau_dixneuf.this, "Hors du plateau", (int)2000).show();
                    }
                	else
                    {
	...
	private void effaceImages(){
		...
		Bitmap bmp = BitmapFactory.decodeResource(getResources(),R.drawable.go19);
